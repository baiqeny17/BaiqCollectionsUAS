...
public class MainActivity extends AppCompatActivity {
    ...
    private void inisialisasiView() {
        ...
        btnSepatu.setOnClickListener(view -> bukaGaleri(getString(R.string.sepatuu_title)));
        btnSandal.setOnClickListener(view -> bukaGaleri(getString(R.string.sendall_title)));
        btnSlop.setOnClickListener(view -> bukaGaleri(getString(R.string.slopp_title)));
